...
public class ExpandableLinearLayout extends LinearLayout implements View.OnClickListener {
    ...
    public ExpandableLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        fontSize = ta.getDimension(R.styleable.ExpandableLinearLayout_tipTextSize, getDensity(context) * 14);
    ...
    private void findViews() {
        ...
        ivArrow = (ImageView) bottomView.findViewById(R.id.item_ell_bottom_iv_arrow);

        tvTip = (TextView) bottomView.findViewById(R.id.item_ell_bottom_tv_tip);
